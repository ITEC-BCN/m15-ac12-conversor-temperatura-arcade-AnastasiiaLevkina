...
class SpriteKind:
    ...
    USA = SpriteKind.create()
    EU = SpriteKind.create()
def convertir_celsius_a_farenheir():
    global temp_c2, temp_f
    temp_c2 = game.ask_for_number("Enter temperature in Celsius:")
    temp_f = 9 / 5 * temp_c2 + 32
    game.show_long_text("" + str(round_decimals(temp_f)) + "Fº", DialogLayout.TOP)

def on_on_overlap(sprite2, otherSprite2):
    global on_america, on_europe
    on_america = True
    on_europe = False
sprites.on_overlap(SpriteKind.player, SpriteKind.USA, on_on_overlap)

def on_up_pressed():
    player_sprite.vy = -150
controller.up.on_event(ControllerButtonEvent.PRESSED, on_up_pressed)

def round_decimals(num: number):
    num = int(num * 100)
    num = num / 100
    return num
def convertir_farenheit_a_celsius():
    global temp_f2, temp_c
    temp_f2 = game.ask_for_number("Enter temperature in Farenheit:")
    temp_c = (temp_f2 - 32) * (5 / 9)
    game.show_long_text("" + str(round_decimals(temp_c)) + "Cº", DialogLayout.TOP)
...
def on_on_overlap2(sprite3, otherSprite):
    ...
    on_america = False
    on_europe = True
sprites.on_overlap(SpriteKind.player, SpriteKind.EU, on_on_overlap2)
...
c_sprite = sprites.create(img("""
    ...
    """),
    SpriteKind.EU)
c_sprite.set_position(136, 70)
f_sprite = sprites.create(img("""
        88888888822222222.....
            81818181811111111.....
            88888888822222222.....
            81818181811111111.....
...
player_sprite = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
player_sprite.set_position(76, 73)
player_sprite.set_stay_in_screen(True)
player_sprite.ay = 300
controller.move_sprite(player_sprite, 100, 0)
game.show_long_text("Go to a flag and press A to convert temperature units.",
    DialogLayout.TOP)

def on_forever():
    characterAnimations.loop_frames(player_sprite,
        [img("""
            . . . . . . f f f f . . . . . . 
                    . . . . f f f 2 2 f f f . . . . 
                    . . . f f f 2 2 2 2 f f f . . . 
    ...
    characterAnimations.loop_frames(player_sprite,
        ...
        """)],
        500,
        characterAnimations.rule(Predicate.HITTING_WALL_DOWN))
forever(on_forever)
